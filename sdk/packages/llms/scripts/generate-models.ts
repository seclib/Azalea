...
import { fetchEnki AIRecommendedProviderModels } from "../src/catalog/catalog-enki-recommended";
...
async function generate(): Promise<void> {
	...
	try {
		const enkiRecommended = await fetchEnki AIRecommendedProviderModels(
			fetch,
			providerModels.openrouter || {},
		);
		Object.assign(providerModels, enkiRecommended);
	} catch (error) {
		loadError =
			error instanceof Error ? error : new Error(String(error ?? "unknown"));
	}
 ...
 *
 * Generated by: @enki/llms/scripts/generate-models.ts
 *
 ...
 * listed in @enki/llms/src/providers/provider-keys.ts
*/
