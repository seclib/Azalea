import type { SqliteDb } from "@enki/shared/db";

/**
 * Bootstrap the dedicated cron.db schema. Unlike @enki/shared's
 * `ensureSessionSchema`, this schema is fully owned by @enki/core
