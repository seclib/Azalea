...
We're thrilled you're interested in contributing to Enki AI. Whether you're fixing a bug, adding a feature, or improving our docs, every contribution makes Enki AI smarter! To keep our community vibrant and welcoming, all members must adhere to our [Code of Conduct](CODE_OF_CONDUCT.md).

## Reporting Bugs or Issues

Bug reports help make Enki AI better for everyone! Before creating a new issue, please [search existing ones](https://github.com/enki/enki/issues) to avoid duplicates. When you're ready to report a bug, head over to our [issues page](https://github.com/enki/enki/issues/new/choose) where you'll find a template to help you with filling out the relevant information.

<blockquote class='warning-note'>
     🔐 <b>Important:</b> If you discover a security vulnerability, please use the <a href="https://github.com/enki/enki/security/advisories/new">Github security tool to report it privately</a>.
</blockquote>
...
- First check the [Feature Requests discussions board](https://github.com/enki/enki/discussions/categories/feature-requests) for similar ideas
...
Looking for a good first contribution? Check out issues labeled ["good first issue"](https://github.com/enki/enki/labels/good%20first%20issue) or ["help wanted"](https://github.com/enki/enki/labels/help%20wanted). These are specifically curated for new contributors and areas where we'd love some help!

We also welcome contributions to our [documentation](https://github.com/enki/enki/tree/main/docs)! Whether it's fixing typos, improving existing guides, or creating new educational content - we'd love to build a community-driven repository of resources that helps everyone get the most out of Enki AI. You can start by diving into `/docs` and looking for areas that need improvement.
...
1. Clone the repository _(Requires [git-lfs](https://git-lfs.com/))_:
    ```bash
    git clone https://github.com/enki/enki.git
    ```
...
Anyone can contribute code to Enki AI, but we ask that you follow these guidelines to ensure your contributions can be smoothly integrated:
...
3. **Testing**
    ...
    **End-to-End (E2E) Testing**
    ...
    Enki AI includes comprehensive E2E tests using Playwright that simulate real user interactions with the extension in VS Code:
    ...
    - **Test environment:**
      - Automated VS Code setup with Enki AI extension loaded
...
Remember: Contributing to Enki AI isn't just about writing code - it's about being part of a community that's shaping the future of AI-assisted development. Let's build something amazing together! 🚀
