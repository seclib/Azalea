...
- Description of fix 1 https://github.com/enki/enki/pull/{PR_NUMBER}
- Description of fix 2 https://github.com/enki/enki/pull/{PR_NUMBER}
```
...
Remind the user to:
1. Manually trigger the publish release GitHub Action at: https://github.com/enki/enki/actions/workflows/ext-vscode-publish-stable.yml (paste `v{VERSION}` as the tag)
