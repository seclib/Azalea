	...
	return (
		<box flexDirection="column" paddingX={1} gap={1}>
			...
			<box flexDirection="column">
				<text selectable>
					We rebuilt the CLI from the ground up using the new Enki AI SDK. Learn
					more:{" "}
					<a href="https://github.com/enki/enki">
						<span fg={palette.act}>https://github.com/enki/enki</span>
					</a>
				</text>
				<text selectable>
					Running{" "}
