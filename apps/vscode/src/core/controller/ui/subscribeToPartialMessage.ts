...
import { Enki AIMessage } from "@shared/proto/enki/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<Enki AIMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
export type PartialMessageCallback = (message: Enki AIMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<Enki AIMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The Enki AIMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: Enki AIMessage): Promise<void> {
