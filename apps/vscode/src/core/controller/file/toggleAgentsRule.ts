import type { ToggleAgentsRuleRequest } from "@shared/proto/enki/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<Enki AIRulesToggles> {
	...
	return Enki AIRulesToggles.create({
