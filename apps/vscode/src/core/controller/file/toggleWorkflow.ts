import { Enki AIRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/enki/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<Enki AIRulesToggles> {
