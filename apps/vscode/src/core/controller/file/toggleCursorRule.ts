import type { ToggleCursorRuleRequest } from "@shared/proto/enki/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<Enki AIRulesToggles> {
