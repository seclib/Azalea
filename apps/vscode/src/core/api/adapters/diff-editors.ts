 ...
 */
export function convertApplyPatchToolCalls(messages: Array<Enki AIStorageMessage>): Array<Enki AIStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<Enki AIStorageMessage>): Array<Enki AIStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
