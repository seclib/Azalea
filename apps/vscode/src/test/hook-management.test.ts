...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/enki/file"
...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "Enki AI", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".enkirules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .enkirules directory gracefully", async function () {
			this.timeout(5000)
