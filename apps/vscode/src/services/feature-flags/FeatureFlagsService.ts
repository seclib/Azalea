import { clearOnboardingModelsCache, getEnki AIOnboardingModels } from "@/core/controller/models/getEnki AIOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/enki/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getEnki AIOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
