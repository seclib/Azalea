...
export async function regexSearchFiles(
	...
	// Filter results using Enki AIIgnoreController if provided
	const filteredResults = enkiIgnoreController
		? results.filter((result) => enkiIgnoreController.validateAccess(result.filePath))
		: results
