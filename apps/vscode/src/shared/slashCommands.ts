...
export const BASE_SLASH_COMMANDS: SlashCommand[] = [
	...
	{
		name: "newrule",
		description: "Create a new Enki AI rule based on your conversation",
		section: "default",
		cliCompatible: true,
	},
	{
		name: "reportbug",
		description: "Create a Github issue with Enki AI",
		section: "default",
		cliCompatible: true,
	},
]
...
export const CLI_ONLY_COMMANDS: SlashCommand[] = [
	{
		name: "help",
		description: "Learn how to use Enki AI CLI",
		section: "default",
		cliCompatible: true,
	},
	{
