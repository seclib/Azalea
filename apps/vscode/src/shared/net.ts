 ...
 * ## Proxy Support
 *
 * Enki AI uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 * 3. View logs: Check ~/.enki/enki-core-service.log for network-related
 *    failures.
