 ...
 * @returns A new array of Enki AIMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: Enki AIMessage[]): Enki AIMessage[] {
