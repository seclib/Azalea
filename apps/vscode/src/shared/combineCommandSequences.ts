...
/**
 * Combines sequences of command and command_output messages in an array of Enki AIMessages.
 *
 * This function processes an array of Enki AIMessages objects, looking for sequences
 ...
 * @returns A new array of Enki AIMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: Enki AIMessage[]): Enki AIMessage[] {
	const combinedCommands: Enki AIMessage[] = []
