 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Enki AI's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Enki AI Checkpoint")
		await git.addConfig("user.email", "checkpoint@enki.bot")
