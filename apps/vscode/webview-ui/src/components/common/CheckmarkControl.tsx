...
import { CheckpointRestoreRequest } from "@shared/proto/enki/checkpoints"
import { Int64Request } from "@shared/proto/enki/common"
...
export const CheckmarkControl = ({ messageTs, isCheckpointCheckedOut }: CheckmarkControlProps) => {
	...
	const handleRestoreTask = async () => {
		...
		try {
			const restoreType: Enki AICheckpointRestore = "task"
	...
	const handleRestoreWorkspace = async () => {
		...
		try {
			const restoreType: Enki AICheckpointRestore = "workspace"
			await CheckpointsServiceClient.checkpointRestore(
				CheckpointRestoreRequest.create({
					number: messageTs,
					restoreType,
	...
	const handleRestoreBoth = async () => {
		...
		try {
			const restoreType: Enki AICheckpointRestore = "taskAndWorkspace"
			await CheckpointsServiceClient.checkpointRestore(
				CheckpointRestoreRequest.create({
					number: messageTs,
					restoreType,
