...
import { OpenAiModelsRequest } from "@shared/proto/enki/models"
		...
		<div>
			...
			<p
				...
				<span style={{ color: "var(--vscode-errorForeground)" }}>
					(<span style={{ fontWeight: 500 }}>Note:</span> Enki AI uses complex prompts and works best with Claude models.
