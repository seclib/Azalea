...
This directory contains the refactored API Options components for the Enki AI extension. The refactoring aims to improve maintainability, code organization, and reduce complexity by separating provider-specific code into modular components.
...
│   ├── Enki AIProvider.tsx       # Enki AI configuration
