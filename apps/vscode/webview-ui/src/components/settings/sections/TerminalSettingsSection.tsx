import { UpdateTerminalConnectionTimeoutResponse } from "@shared/proto/index.enki"
				...
				<div className="mb-5" id="terminal-settings-section">
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							Select the default terminal Enki AI will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							Set how long Enki AI waits for shell integration to activate before executing commands. Increase this
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							When enabled, Enki AI will reuse existing terminal windows that aren't in the current working directory.
					...
					{isVsCodePlatform && (
						<div className="mb-4">
							...
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								Choose whether Enki AI runs commands in the VS Code terminal or a background process.
							</p>
						</div>
					)}
					...
					<div className="mt-5 p-3 bg-(--vscode-textBlockQuote-background) rounded border border-(--vscode-textBlockQuote-border)">
						<p className="text-[13px] m-0">
							...
							<a
								...
								href="https://docs.enki.bot/troubleshooting/terminal-quick-fixes"
							...
							<a
								className="text-(--vscode-textLink-foreground) underline hover:no-underline"
								href="https://docs.enki.bot/troubleshooting/terminal-integration-guide"
								rel="noopener noreferrer"
								target="_blank">
