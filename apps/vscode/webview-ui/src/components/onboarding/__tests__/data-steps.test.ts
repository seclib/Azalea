...
describe("getUserTypeSelections", () => {
	it("omits the Enki AIPass option when the flag is disabled", () => {
	...
	it("inserts Enki AIPass right after the free option when the flag is enabled", () => {
		const selections = getUserTypeSelections(true)
		// Free stays first (and remains the default selection); Enki AIPass is the
