...
export function useScrollBehavior(
	...
	visibleMessages: Enki AIMessage[],
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<Enki AIMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: Enki AIMessage | null = null
