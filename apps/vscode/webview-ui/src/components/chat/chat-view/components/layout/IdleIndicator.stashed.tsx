 ...
 */
export function useIdleIndicator(scrollContainerRef: React.RefObject<HTMLDivElement>, enkiMessages: Enki AIMessage[]): boolean {
	...
	useEffect(() => {
		...
		const isTaskComplete = enkiMessages.some(
	...
	}, [scrollContainerRef, enkiMessages])
