...
import { FileSearchRequest, FileSearchType, RelativePathsRequest } from "@shared/proto/enki/file"
import { PlanActMode, TogglePlanActModeRequest } from "@shared/proto/enki/state"
...
import Enki AIRulesToggleModal from "../enki-rules/Enki AIRulesToggleModal"
				...
				<div className="flex justify-between items-center -mt-[2px] px-3 pb-2">
					...
					<Tooltip>
						<TooltipContent
							...
							side="top">
							{`In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, Enki AI will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
